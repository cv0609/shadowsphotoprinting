...
<div class="right_col" role="main">
    ...
    <div class="bottom_refund_btn_class">
       <div class="fefund_btn">
          <a href="{{ ($orderDetail->order_status != "3") ? route('refund-order',['order_id'=>$orderDetail->id]) : '#' }}" class="{{ (($orderDetail->order_status == "3")) ? 'not-allowed' : '' }}" onclick="{{ (($orderDetail->order_status == "3")) ? '' : return confirm('Are you sure!') }}">refund</a>
        </div>

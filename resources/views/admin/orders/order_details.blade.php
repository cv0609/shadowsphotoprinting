        ...
        <table class="table">
          ...
          <tbody>
            ...
            <td class="right order_page_td">
              ...
              <td class="center order_page_td">{{ $item->quantity }}</td>
              <td class="right order_page_td">$  @if($item->product_type == "gift_card")

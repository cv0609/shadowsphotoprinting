    ...
    <div class="container">
        <div class="subcate">
            <ul class="cstmlist">
                @foreach ($productCategories as $productCategory)
                <li class="central">
                    <a href="{{ route('photos-for-sale',['slug'=>$productCategory->slug]) }}" target="_blank" class="{{ Request::url() == route('photos-for-sale', ['slug' => $productCategory->slug]) ? 'product-cat-active' : '' }}">{{ ucfirst($productCategory->product_title) }}</a>
                </li>
                @endforeach
            </ul>
        </div>
                    ...
                    <div class="clearfix kold">
                        ...
                        <div class="details-product-item">
                            ...
                            <div class="afterpay-4-payment">
                                <span>or 4 payments as low as ${{ number_format($product->min_price / 4, 2) }} with </span>

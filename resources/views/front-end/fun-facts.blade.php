      ...
      <div class="container">
        <div class="about-printing">
          ...
          <p>
            ...
            often appear darker than what you see on your screen.
          </p>

          <!-- ---------------------------------------------------------------------------------------------------------- -->
          <h3>CMYK Colour Space</h3>
          <p>
            CMYK is more commonly used for other types of printing, such as
            magazines, newspapers, and large commercial print runs.
          </p>
          <p>
            These types of printing use a different process to photographic
            printing.
          </p>
          <p>
            Our printers are designed for photographic printing and work in RGB
            (sRGB), which means CMYK files may not print correctly through our
            system.
          </p>
          <p>
            If a CMYK file is supplied, colours can appear dull, flat, or
            incorrect.
          </p>
          ...
          <!-- <p>
            Before printing we convert the files with our printing profile
            ensuring amazing quality.
          </p> -->

          <!-- ---------------------------------------------------------------------------------------------------------  -->
          <h3>Setting Greyscale Files</h3>
          <p>
            Please check your files if you are working in greyscale, as if you
            leave the source space set as Working
            <strong>Grey Dot Gain 20% (Adobe ACE)</strong>, our
            <strong>SureLab</strong> order control will not process the file
            correctly, and this is why they can come out looking green.
          </p>
          <p>
            Please check your files are set correctly as sRGB for printing via
            the instructions below before you upload them.
          </p>
          <p>
            You will need to open the file in Photoshop, go to Edit, then to
            Convert to Profile, select sRGB, click OK, and then save the file.
          </p>
          <p>
            As we do not change these files that are set in the greyscale source
            space as <strong>Working Grey Dot Gain 20% (Adobe ACE)</strong>,
            this falls back on to you to have your files set correctly for the
          ...
          <p>
            ...
            <strong>3:2 ratio is the 4:3 ratio</strong>.
          </p>
          <p>
          ...
          <h4>Question!</h4>
          <p>
            I am unhappy with my photo as I saved a 14×11” and they all came
            back larger with white edges on the side!
          </p>
          <h4>Answer!</h4>
          <p>
            We print your files to
            <strong> (FIT ON WHATEVER SIZED MEDIA “PAPER” YOU CHOOSE).</strong>
          </p>
          <p>
          ...
          <p>
            If you want to make <strong>14”x11”</strong> enlargements, you will
          ...
          <!-- ---------------------------------------------------------------------------------------------  -->
          <h4>Question!</h4>
          <p>What Pixels should I export out of my Scrapbooking Program?</p>
          <h4>Answer!</h4>
          <p>
          ...
          <ul style="list-style: disc; padding-left: 30px; color: white;">
            ...
            <li>
              <p>Keep your file in
              <strong>RGB colour space (sRGB preferred)</strong></p>
            </li>
          </ul>
          ...
          <h4>Borders</h4>
          <p>
            We recommend a 4mm white border if your prints are to be framed or
            if you are not sure about the ratio.
          </p>
          <p>
            The 4mm border doesn’t bleed out, however you may sometimes notice a
            slight skew on the white edge <strong>(less than 5mm)</strong>. This
            happens because the paper travels through guides in the printer and
            needs a small amount of movement to pass through smoothly.
          </p>
          ...
          <h4>Bleeding</h4>
          <p>
            Please note our printer will crop <strong> 2-3%</strong> from the
            outer edge of the image.
          </p>
          <p>
            If you do not wish to lose any of the image, please select borders
            on your prints. This is especially important if you have text or
            important details close to the edge.
          </p>

          <!-- ------------------------------------------------------------------------------------------------------  -->

          <h4>Question!</h4>
          <p>Do you have a discount rate for larger order?</p>
          <h4>Answer!</h4>
          <p>
            Yes, at <strong>Shadows Affordable Memories</strong> we offer
          ...
          <p>
            This is a great option for professional photographers or to update
            the family photo album.
          </p>
          <p>
            At Shadows Affordable Memories, we understand how important your
            cherished moments are.
          </p>
          <p>
            We try to keep our prices affordable for everyone, and we also have
            Afterpay available.
          </p>
          <!-- ---------------------------------------------------------------------------------------------------------------------  -->

          <p class="color_yellow"><strong>3rd Party Orders </strong></p>
          <p>
            If you choose 3rd party orders, we will not send any invoices to the
            third party.
          </p>
          <p>
            We charge a <strong>$2.00</strong> for this service to cover the
            extra handling and postage.
          </p>
          <!-- ----------------------------------------------------------------------------------------------------------  -->
          <p class="color_yellow"><strong>Credits Not Given </strong></p>
          <p><strong> No Credits Given for Customers Errors!</strong></p>
          <p>
            We print the size of the photo that you have requested on the order
            sheet when you place your order.
          </p>
          <p>
            <strong
              >If you choose the wrong size this falls back on to you,</strong
            >
            as we do not change the size of your images.
          </p>
          <!-- ------------------------------------------------------------------------------------------------------------  -->
          <p class="color_yellow"><strong>Setting Greyscale Files </strong></p>
          <p>
            As we do not change these files that are set in the greyscale source
            space as <strong>Working Grey Dot Gain 20% (Adobe ACE),</strong> if
            your files are set incorrectly, this falls back on to you.
          </p>
          <p>
            Please make sure that your images are in the correct
            <span>RATIOS – ASPECT RATIO</span> and saved as
            <strong>sRGB</strong> before you place your order.
          </p>

          <p>
            However, if you need any help or advice on checking the size or
            setting your files for printing, please feel free to contact our
            team!
          </p>

          <p class="color_yellow">
            <strong>Damaged in the mailing system </strong>
          </p>
          <p>
          ...
          <p>
            ...
            If the order has been lost, we will reprint your order at no

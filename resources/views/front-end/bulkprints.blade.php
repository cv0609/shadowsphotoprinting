    ...
    <div class="adbreadcrumbs">
        <div class="container">
            <div class="breadcrumbs-wrapper">
                ...
                <span class="bc-delimiter">»</span>
                <span><a href="javascript:void(0)">Bulkprints</a></span>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="subcate">
            <ul class="cstmlist">
                @foreach ($productCategories as $productCategory)
                   <li class="central"> <a href="{{ url('our-products/'.str_replace(' ', '-', strtolower($productCategory->name)))}}" target="_blank">{{ ucfirst($productCategory->name) }}</a> </li>
               @endforeach
            </ul>
        </div>
    </div>
        ...
        <div class="notices-wrapper">
            <div class="kad-shop-top">
                <div class="results-count">
                    <p> Showing all {{$products->perPage()}} results</p>
                </div>
                ...
                @foreach ($products as $product)
                    <li class="type-product">
                        <div class="clearfix kold">
                            ...
                            <a href="{{ route('bulkprints-product',['slug'=>$product->slug]) }}">
                                <div class="noflipper" id="image-div">
                                  <div class="product-animation2">

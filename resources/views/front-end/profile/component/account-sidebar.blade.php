    ...
    <div class="MyAccount-navigation">
        ...
        <ul class="ashboard prod">
         ...
         @if(Auth::user()->role == 'affiliate')
           <li class=""> <a href="{{ route('ambassador') }}" class="{{ Request::url() == route('ambassador') ? 'active' : '' }}">Ambassador<i class="fa fa-users"></i></a> </li>
           <li class=""> <a href="{{ route('ambassador.blog') }}" class="{{ Request::url() == route('ambassador.blog') ? 'active' : '' }}" >Blog <i class="fa fa-pencil-square-o"></i></a> </li>

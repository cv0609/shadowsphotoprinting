...
<body style="font-family: Roboto Serif, serif; background-color: #f9f9f9; margin: 0; padding: 0;">
    <div
        ...
        <div style="padding: 40px 30px;">
            ...
            <!-- Coupon Code Box -->
            <div style="background-color: #16a085; color: white; padding: 25px; text-align: center; border-radius: 10px; margin: 30px 0; box-shadow: 0 4px 15px rgba(32, 201, 151, 0.3);">
            ...
            <div style="background-color: #f8f9fa; padding: 25px; border-radius: 10px; margin: 25px 0;">
                ...
                <ol style="color: #555; font-size: 16px; line-height: 1.8; margin: 0; padding-left: 20px;">
                    <li style="margin-bottom: 8px;">Browse our products at <a href="{{ url('/shop') }}" style="color: #16a085; text-decoration: none; font-weight: bold;">shadowsphotoprinting.com</a></li>
                    <li style="margin-bottom: 8px;">Add items to your cart</li>
                    <li style="margin-bottom: 8px;">At checkout, enter your coupon code: <strong style="color: #16a085;">{{ $data['coupon_code'] }}</strong></li>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{ url('/shop') }}" 
                   style="display: inline-block; background-color: #16a085; color: white; padding: 15px 35px; text-decoration: none; border-radius: 8px; font-weight: bold; font-size: 16px; box-shadow: 0 4px 15px rgba(32, 201, 151, 0.3);">
                    🛒 Start Shopping Now
                </a>
            </div>
            ...
            <p style="color: #16a085; font-weight: bold; font-size: 16px; margin: 0;">The Shadows Photo Printing Team</p>
        </div>

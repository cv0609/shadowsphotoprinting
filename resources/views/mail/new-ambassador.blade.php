...
<head>
    ...
    <title>New Ambassador Request Submitted
    </title>
                ...
                <tr>
                    <td>
                        <p style="margin: 5px 0;">
                            A new ambassador request has just been submitted on the website. Here are the details:
                        </p>
                        <ul>
                            <li><strong>Name:</strong> {{ $ambassador->name }}</li>
                            <li><strong>Email:</strong> {{ $ambassador->email }}</li>
                            <li><strong>Submitted At:</strong> {{ now()->format('F j, Y, g:i a') }}</li>
                        </ul>
                    
                        <p>Please review and approve the request via the admin panel.</p>
                    </td>
